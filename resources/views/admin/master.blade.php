...
>
  ...
  <body>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Top Slider Management">Slider Management</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="category managemente">Category Management</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <form method="POST" action="{{ route('admin.logout') }}" style="cursor: pointer;">
                        @csrf
    ...
    <!-- Long Modal -->
    <div class="modal fade" id="lgModal" tabindex="-1" aria-hidden="true">
